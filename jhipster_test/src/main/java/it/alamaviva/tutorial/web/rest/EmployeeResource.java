...
/**
 * REST controller for managing {@link it.alamaviva.tutorial.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeResource {
    ...
    public ResponseEntity<List<EmployeeDTO>> getAllEmployees(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
