...
import { ContactMyEmployeeComponent } from 'app/entities/contact-my-employee/contact-my-employee.component';
...
describe('Component Tests', () => {
  describe('ContactMyEmployee Management Component', () => {
    let comp: ContactMyEmployeeComponent;
    let fixture: ComponentFixture<ContactMyEmployeeComponent>;
    let service: ContactMyEmployeeService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [JhipsterTestTestModule],
        declarations: [ContactMyEmployeeComponent],
        providers: [
          {
        ...
        .overrideTemplate(ContactMyEmployeeComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ContactMyEmployeeComponent);
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new ContactMyEmployee(123)],
            headers
          })
        )
      );
