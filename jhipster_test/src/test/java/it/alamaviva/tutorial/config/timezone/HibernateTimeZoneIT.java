package it.alamaviva.tutorial.config.timezone;

import it.alamaviva.tutorial.JhipsterTestApp;
import it.alamaviva.tutorial.repository.timezone.DateTimeWrapper;
import it.alamaviva.tutorial.repository.timezone.DateTimeWrapperRepository;
