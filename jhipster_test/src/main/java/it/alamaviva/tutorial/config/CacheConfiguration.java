package it.alamaviva.tutorial.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, it.alamaviva.tutorial.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, it.alamaviva.tutorial.repository.UserRepository.USERS_BY_EMAIL_CACHE);
